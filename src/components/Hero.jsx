...
export default function Hero() {
  ...
  const webpSrcSet = (src) =>
    `${src.replace(/\.webp$/, "-480.webp")} 480w, ${src.replace(/\.webp$/, "-768.webp")} 768w`;
  const src768 = (src) => src.replace(/\.webp$/, "-768.webp");
  ...
  return (
    <section
      id="home"
      className="relative h-auto min-h-[100svh] lg:h-[100vh] lg:min-h-[720px] overflow-visible lg:overflow-hidden flex items-start lg:items-center bg-black touch-pan-y pt-12 sm:pt-24 lg:pt-0"
    ...
    >
      ...
      <div className="absolute inset-0 z-0 overflow-hidden hidden lg:block">
        <AnimatePresence mode="wait">
          ...
          >
            <img
              src={src768(slide.bg || slide.image)}
              alt="background"
              srcSet={webpSrcSet(slide.bg || slide.image)}
              sizes="100vw"
              loading="eager"
              decoding="async"
      ...
      <div className="relative z-[5] w-full max-w-[1760px] mx-auto px-4 sm:px-5 md:px-6 lg:px-8 xl:px-10 2xl:px-12 py-10 sm:py-12 md:py-14 lg:py-4 grid grid-cols-1 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] xl:grid-cols-[minmax(0,1.08fr)_minmax(0,0.92fr)] gap-7 sm:gap-8 md:gap-10 lg:gap-10 xl:gap-14 items-center justify-center lg:text-left lg:-translate-x-3 xl:-translate-x-4 2xl:-translate-x-6">
        {/* LEFT CONTENT COLUMN */}
        <div className="flex flex-col justify-center min-w-0 min-h-0 md:min-h-[500px] mt-6 md:mt-8 lg:mt-12 lg:pl-6 xl:pl-10">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="relative w-full max-w-[570px] overflow-hidden rounded-[20px] border border-white/10 backdrop-blur-xl bg-white/5 shadow-[0_20px_80px_rgba(0,0,0,0.6)]">
                <img
                  src={src768(slide.image)}
                  alt={slide.title}
                  srcSet={webpSrcSet(slide.image)}
                  sizes="(max-width: 640px) 92vw, 570px"
